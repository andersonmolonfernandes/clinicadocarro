...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      { rel: "icon", type: "image/x-icon", href: "/favicon.ico?v=20260819" },
      { rel: "icon", type: "image/png", sizes: "48x48", href: "/icons/favicon-48x48.png?v=20260819" },
      { rel: "icon", type: "image/png", sizes: "96x96", href: "/icons/favicon-96x96.png?v=20260819" },
      { rel: "icon", type: "image/png", sizes: "192x192", href: "/icons/favicon-192x192.png?v=20260819" },
      { rel: "icon", type: "image/png", sizes: "512x512", href: "/icons/favicon-512x512.png?v=20260819" },
      { rel: "shortcut icon", href: "/favicon.ico?v=20260819" },
      { rel: "apple-touch-icon", sizes: "180x180", href: "/icons/apple-touch-icon.png?v=20260819" },
      { rel: "manifest", href: "/manifest.webmanifest" },
      { rel: "preload", as: "image", href: "/logo-mark.png" },
