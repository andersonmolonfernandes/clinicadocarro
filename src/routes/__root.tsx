...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      { rel: "icon", type: "image/x-icon", href: "/favicon.ico?v=20260809" },
      { rel: "icon", type: "image/png", sizes: "16x16", href: "/icons/favicon-16x16.png?v=20260809" },
      { rel: "icon", type: "image/png", sizes: "32x32", href: "/icons/favicon-32x32.png?v=20260809" },
      { rel: "icon", type: "image/png", sizes: "48x48", href: "/icons/favicon-48x48.png?v=20260809" },
      { rel: "icon", type: "image/png", sizes: "96x96", href: "/icons/favicon-96x96.png?v=20260809" },
      { rel: "icon", type: "image/png", sizes: "192x192", href: "/icons/favicon-192x192.png?v=20260809" },
      { rel: "icon", type: "image/png", sizes: "512x512", href: "/icons/favicon-512x512.png?v=20260809" },
      { rel: "shortcut icon", href: "/favicon.ico?v=20260809" },
      { rel: "apple-touch-icon", sizes: "180x180", href: "/icons/apple-touch-icon.png?v=20260809" },
      { rel: "mask-icon", href: "/icons/favicon-512x512.png?v=20260809", color: "#00e676" },
      { rel: "manifest", href: "/manifest.webmanifest?v=20260809" },
          ...
          "@graph": [
            {
              ...
              description:
                "Estética automotiva em Joinville/SC desde 2013: polimento técnico, vitrificação cerâmica, higienização interna, martelinho de ouro, restauração de faróis, cristalização de para-brisa e lavação premium.",
              ...
              logo: {
                ...
                url: "https://clinicadocarro.vercel.app/logo.png?v=20260809",
                contentUrl: "https://clinicadocarro.vercel.app/logo.png?v=20260809",
                width: 1254,
                height: 1254,
                caption: "Clínica do Carro Studio Detail",
              },
              image: "https://clinicadocarro.vercel.app/logo.png?v=20260809",
            },
            {
              "@type": "WebSite",
