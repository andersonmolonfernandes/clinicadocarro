    ...
    faqs: [
      {
        ...
        resposta:
          "Com uma proteção aplicada logo após o serviço, o resultado do polimento se mantém de 6 a 12 meses. Com vitrificação cerâmica, a durabilidade pode chegar a 3 anos.",
      },
      {
    ...
    faqs: [
      {
        ...
        resposta:
          "Até 3 anos, dependendo do uso do veículo, da exposição ao sol e dos cuidados na lavagem. Lavagens corretas prolongam bastante a proteção.",
      },
      {
